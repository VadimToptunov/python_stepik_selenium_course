# Упражнения по курсу "Автоматизация тестирования с помощью Selenium и Python" на платформе [Stepik](https://stepik.org/) 
...
4. [Начальный пример тестов для pytest, перехват exception](https://github.com/VadimToptunov/python_stepik_selenium_course/blob/main/selenium_course/chapter3/lesson3_step9.py)
...
## Page Object Model
1. [Page Object Model репозиторий](https://github.com/VadimToptunov/stepik_page_object)